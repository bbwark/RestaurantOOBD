...
public class addPanelServizioToCameriere extends JPanel {
    ...
    public addPanelServizioToCameriere(){
        setLayout(new GridBagLayout());

        Border bordoInterno = BorderFactory.createTitledBorder("Aggiungi Servizio a Cameriere selezionato");
