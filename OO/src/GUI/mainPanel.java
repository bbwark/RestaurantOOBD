...
public class mainPanel extends JPanel {
    ...
    public mainPanel(String tipo) {
        ...
        buttonAdd = new JButton("+ " + tipo);
        buttonEdit = new JButton("Modifica " + tipo);

        labelNomeSelezionato = new JLabel("Nome " + tipo + " Selezionato: ");
        labelNomeElementoSelezionato = new JLabel("*nome*");

        labelListaSelezione = new JLabel("Lista " + tipo);
        ...
        labelTableVisualizza = new JLabel("Lista Sottoelementi di " + tipo + " *nome*");
        ...
        buttonMostraSottoelemento = new JButton("Mostra Sottoelemento di " + tipo);
        buttonAddPrenotazione = new JButton("+ Prenotazione");
