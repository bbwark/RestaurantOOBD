...
public class addPanelClienteToPrenotazione extends JPanel {
    ...
    public addPanelClienteToPrenotazione(){
        setLayout(new GridBagLayout());

        Border bordoInterno = BorderFactory.createTitledBorder("Aggiungi Cliente a Prenotazione selezionata");
        Border bordoEsterno = BorderFactory.createEmptyBorder(10, 10, 10, 10);
        Border bordoFinale = BorderFactory.createCompoundBorder(bordoEsterno, bordoInterno);
        setBorder(bordoFinale);

        labelSelezione = new JLabel("Lista Clienti Disponibili");
